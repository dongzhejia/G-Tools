...
# ToolTaskCollector
class ToolTaskCollector(object):
    def __init__(self, xcfg, ignoreFilename=None):
        super(ToolTaskCollector, self).__init__()
        ...
        if ignoreFilename:
            try:
                ...
                ignoreFile.close()
                userIgnoreRule = ToolIgnore.ZGitIgnore.fromLines(lines)
    ...
    def _collectXFiles(self, rootpath):
        print(rootpath)
        ACT_VISITFILE = ToolPathTraveller.ACT_VISITFILE
        ACT_ENTERDIR = ToolPathTraveller.ACT_ENTERDIR
        ACT_LEAVEDIR = ToolPathTraveller.ACT_LEAVEDIR
